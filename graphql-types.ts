...
export type FrontmatterStartArgs = {
  formatString: InputMaybe<Scalars['String']>;
  fromNow: InputMaybe<Scalars['Boolean']>;
  difference: InputMaybe<Scalars['String']>;
  locale: InputMaybe<Scalars['String']>;
...
export type FrontmatterEndArgs = {
  formatString: InputMaybe<Scalars['String']>;
  fromNow: InputMaybe<Scalars['Boolean']>;
  difference: InputMaybe<Scalars['String']>;
  locale: InputMaybe<Scalars['String']>;
...
export type FrontmatterFilterInput = {
  ...
  roll: InputMaybe<StringQueryOperatorInput>;
...
export type FileFieldsEnum =
  ...
  | 'childrenMarkdownRemark___frontmatter___roll'
  ...
  | 'childMarkdownRemark___frontmatter___roll'
...
export type SiteSiteMetadataFilterInput = {
  ...
  social: InputMaybe<SocialFilterListInput>;
...
export type SocialFilterListInput = {
  elemMatch: InputMaybe<SocialFilterInput>;
};
...
export type BioQueryQuery = { avatar: { childImageSharp: { fixed: { base64: string | null, width: number, height: number, src: string, srcSet: string } | null } | null } | null, site: { siteMetadata: { location: string, role: string, author: { name: string, summary: string } } | null } | null };
...
export type BioSocialsQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type BioSocialsQueryQuery = { site: { siteMetadata: { social: Array<{ name: string | null, url: string | null }> } | null } | null };
...
export type FrontPageQuery = { site: { siteMetadata: { title: string | null } | null } | null, allMarkdownRemark: { nodes: Array<{ excerpt: string | null, html: string | null, fields: { slug: string | null, collection: string | null }, frontmatter: { title: string | null, description: string | null, roll: string | null, url: string | null, start: any | null, end: any | null } }> } };
...
export type BlogPostBySlugQuery = { site: { siteMetadata: { title: string | null } | null } | null, markdownRemark: { id: string, excerpt: string | null, html: string | null, frontmatter: { title: string | null, start: any | null, description: string | null } } | null, previous: { fields: { slug: string | null }, frontmatter: { title: string | null } } | null, next: { fields: { slug: string | null }, frontmatter: { title: string | null } } | null };

export type WorkPostBySlugQueryVariables = Exact<{
  id: Scalars['String'];
  previousPostId: InputMaybe<Scalars['String']>;
  nextPostId: InputMaybe<Scalars['String']>;
}>;
...
export type WorkPostBySlugQuery = { site: { siteMetadata: { title: string | null } | null } | null, markdownRemark: { id: string, excerpt: string | null, html: string | null, frontmatter: { title: string | null, description: string | null, roll: string | null, start: any | null, end: any | null } } | null, previous: { fields: { slug: string | null }, frontmatter: { title: string | null } } | null, next: { fields: { slug: string | null }, frontmatter: { title: string | null } } | null };
